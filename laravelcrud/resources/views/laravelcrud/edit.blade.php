            ...
            <div class="col-lg-6 m-auto">
                <div class="card mt-5">
                    <div class="card-header">
                        ...
                        <div class="card-body">
                            <form method="post" id="register" action="{{route('laravelcrud.update',$crud->id)}}">
                    ...
                    <div class="card-footer">
                        ...
                        <button onclick="location.href='{{route('read')}}';" value="Back" class="btn btn-success">Back</button>
                    </div>
                </div>
            </div>
        </div>
